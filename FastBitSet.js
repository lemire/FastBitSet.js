...
FastBitSet.prototype.equals = function (otherbitmap) {
    ...
    if (this.count < otherbitmap.count) {
        ...
        var c = this.count;
        for (k = otherbitmap.count; k < c; k += 1) {
            if (this.words[k] != 0) {
                return false;
            }
        }
